...
function route(string $method, string $uri): void
{
    ...
    match(true) {
        ...
        $method === 'GET' && $uri === 'charts' => (new ProjectController())->getAllCharts(),
        ...
        $method === 'POST' && $uri === 'projects/smart-create/pending/dismiss' => (new SmartProjectController())->dismissPending(),
